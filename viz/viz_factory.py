...
class VizFactory:
    ...
    def render_viz(self, chart_type, headers, n_sizes, iteration_data, render_options):
        ...
        if track:
            ...
            for data in iteration_data:
                ...
                self.add_points(iter_lines, fn_names, fn_points, tottime_idx)
        else:
            all_descriptors = []
            all_lines = []
            iter_lines = []
            ...
            for group in iter_lines:  # only contains
                self.add_points(np.array(group), fn_names, fn_points, tottime_idx)
    ...
    def add_points(self, iter_lines, fn_names, fn_points, tottime_idx):
